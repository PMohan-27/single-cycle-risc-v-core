...
def load_rv32i_test_program(dut):
    ...
    dut.instruction_memory_inst.instr[0].value = 0b00000001111100001000010001100011  # BEQ x1, x1, 8
    dut.instruction_memory_inst.instr[1].value = 0b00000110001100000000111110010011  # ADDI x31, x0, 99 (SKIP)
    dut.instruction_memory_inst.instr[2].value = 0b00000000001000001001010001100011  # BNE x1, x2, 8
    dut.instruction_memory_inst.instr[3].value = 0b00000101100000000000111110010011  # ADDI x31, x0, 88 (SKIP)
    dut.instruction_memory_inst.instr[4].value = 0b00000000000100100100010001100011  # BLT x4, x1, 8
    dut.instruction_memory_inst.instr[5].value = 0b00000100110100000000111110010011  # ADDI x31, x0, 77 (SKIP)
    dut.instruction_memory_inst.instr[6].value = 0b00000000010000001101010001100011  # BGE x1, x4, 8
    dut.instruction_memory_inst.instr[7].value = 0b00000100001000000000111110010011  # ADDI x31, x0, 66 (SKIP)
    dut.instruction_memory_inst.instr[8].value = 0b00000000001000011110010001100011  # BLTU x3, x2, 8
    dut.instruction_memory_inst.instr[9].value = 0b00000011011100000000111110010011  # ADDI x31, x0, 55 (SKIP)
    dut.instruction_memory_inst.instr[10].value = 0b00000000001100010111010001100011  # BGEU x2, x3, 8
    dut.instruction_memory_inst.instr[11].value = 0b00000010110000000000111110010011  # ADDI x31, x0, 44 (SKIP)
